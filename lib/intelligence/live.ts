...
export async function indexedTradeSnapshot(limit = 100, options: { token?: string; wallets?: string[]; side?: string; minUsd?: number; query?: string } = {}): Promise<AnalystTrade[]> {
