...
export function LiveIndicator({
  ...
  const status = data?.provider === "chain" && data.status !== "live" ? data.status : stream.enabled && !connecting ? stream.status : data?.status ?? "offline";
